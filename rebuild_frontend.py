...
export default function MainLayout() {
  ...
  // Hide nav on certain screens if needed
...
import React from 'react';
import { motion } from 'framer-motion';
import { BellIcon, CloudRainIcon, CloudIcon } from '@heroicons/react/24/outline';
    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="p-6">
      ...
      <div className="bg-gradient-to-br from-primary to-secondary rounded-[2rem] p-6 text-white shadow-xl shadow-primary/20 mb-8 relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 mt-6 pt-4 border-t border-white/20 relative z-10">
          <div className="flex items-center gap-2"><CloudRainIcon className="w-5 h-5 text-white/80" /><span className="text-sm font-medium">10% Rain</span></div>
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="h-full bg-dark flex flex-col relative">
      ...
      <div className="flex-1 relative overflow-hidden flex flex-col items-center justify-center">
        {!result ? (
          ...
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="absolute bottom-0 w-full bg-white rounded-t-[2rem] p-6 shadow-2xl">
...
print("Complete frontend structure and React Router paths generated successfully.")
